...
class RechargeEtecsaTypeController extends Controller
{
    ...
    /**
     * Lists all RechargeEtecsaType models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new RechargeEtecsaTypeSearch();
    ...
    /**
     * Displays a single RechargeEtecsaType model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new RechargeEtecsaType model.
     * If creation is successful, the browser will be redirected to the 'index' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new RechargeEtecsaType();
    ...
    /**
     * Updates an existing RechargeEtecsaType model.
    ...
    /**
     * Deletes an existing RechargeEtecsaType model.
    ...
    /**
    * Bulk Deletes for existing RechargeEtecsaType models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    * @return mixed
    */
