...
class SettingController extends Controller
{
    ...
    public function actionChangeOfficeStatus() {

        $model = Setting::find()->one();

        $model->office_status = !$model->office_status;

        if($model->save(false)) {
            GlobalFunctions::addFlashMessage('success',Yii::t('backend','Estado de oficina actualizado correctamente'));
        } else {
            GlobalFunctions::addFlashMessage('danger',Yii::t('backend','Error actualizando el estado de oficina'));
        }
