...
use backend\models\business\AppAccessSearch;
...
/**
 * AppAccessController implements the CRUD actions for AppAccess model.
 */
class AppAccessController extends Controller
{
    ...
    /**
     * Lists all AppAccess models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new AppAccessSearch();
    ...
    /**
     * Displays a single AppAccess model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing AppAccess model.
    ...
    /**
     * Deletes an existing AppAccess model.
    ...
    /**
     * Finds the AppAccess model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AppAccess the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AppAccess::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
    * Bulk Deletes for existing AppAccess models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    * @return mixed
    */
