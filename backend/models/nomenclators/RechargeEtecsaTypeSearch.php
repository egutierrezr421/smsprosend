...
/**
 * RechargeEtecsaTypeSearch represents the model behind the search form of `backend\models\nomenclators\RechargeEtecsaType`.
 */
class RechargeEtecsaTypeSearch extends RechargeEtecsaType
{
    /**
     * @inheritdoc
     */
