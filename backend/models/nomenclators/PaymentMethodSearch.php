...
/**
 * PaymentMethodSearch represents the model behind the search form of `backend\models\nomenclators\PaymentMethod`.
 */
class PaymentMethodSearch extends PaymentMethod
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['name', 'code', 'description', 'created_at', 'updated_at','commission','target_account'], 'safe'],
            [['status'], 'boolean'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['ilike', 'name', $this->name])
            ...
            ->andFilterWhere(['ilike', 'target_account', $this->target_account])
        ;
