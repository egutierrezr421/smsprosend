...
class CustomerSearch extends Customer
{
    ...
    {
        return [
            [['id', 'user_id', 'country_id', 'status', 'allow_send_sms', 'send_sms_type', 'max_sms'], 'integer'],
            [['name', 'code', 'phone_number', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'send_sms_type' => $this->send_sms_type,
