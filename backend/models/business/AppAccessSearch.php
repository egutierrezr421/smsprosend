...
/**
 * AppAccessSearch represents the model behind the search form of `backend\models\business\AppAccess`.
 */
class AppAccessSearch extends AppAccess
{
    /**
     * @inheritdoc
     */
