...
<div class="box-body">
    ...
    if (($tableSchema = $generator->getTableSchema()) === false) {
        ...
        [
            'attribute'=> '<?= $name ?>',
            'value'=> (isset($model-><?= $name ?>) && !empty($model-><?= $name ?>))? User::getFullNameByUserId($model-><?= $name ?>) : null,
            'format' => 'html',
        ],
            <?php } else {  ?>
        [
            'attribute'=> '<?= $name ?>',
            'value'=> (isset($model-><?= $name ?>) && !empty($model-><?= $name ?>))? $model-><?= $classrelationLower ?>->name : null,
            'format'=> 'html',
        ],
            <?php }
                echo "\n";
