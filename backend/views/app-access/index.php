...
/* @var $searchModel backend\models\business\AppAccessSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$controllerId = '/'.$this->context->uniqueId.'/';
$this->title = Yii::t('backend', 'Integración API');
...
<?php 
	if (Helper::checkRoute($controllerId . 'create')) {
		$create_button = Html::a('<i class="fa fa-plus"></i> '.Yii::t('backend', 'Crear'), ['create'], ['class' => 'btn btn-default btn-flat margin', 'title' => Yii::t('backend', 'Crear').' '.Yii::t('backend', 'AppAccess')]);
	}
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'format'=> 'html',
                    'filterType' => GridView::FILTER_SELECT2,
                    'filter' => AppAccess::getFieldLabels('name'),
                    'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                    'options' => ['multiple' => false],
                    ],
                ...
                [
                    ...
                    'format'=> 'raw',
                    'filterType' => GridView::FILTER_SELECT2,
                    'filter' => AppAccess::getFieldLabels('token'),
                    'filterWidgetOptions' => [
                        'pluginOptions' => ['allowClear' => true],
                        'options' => ['multiple' => false],
                    ],
                    ...
                    'value' => function($model) {
                        return $model->token.' '.'<button class="btn btn-flat btn-xs btn-primary copy_btn" value="'.$model->token.'" data-toggle="tooltip" data-original-title="Copiar" data-copied-title="Copiado"><i class="fa fa-clone"></i></button>';
                    }
                ],
