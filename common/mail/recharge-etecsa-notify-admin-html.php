...
if($is_frontend) {
    ...
    $link = Yii::$app->urlManagerBackend->createAbsoluteUrl(['/recharge-etecsa/update', 'id' => $recharge_id]);

} else {
    $path_logo = Yii::$app->getBasePath().'/web'.Setting::getUrlLogoBySettingAndType(1,Setting::SETTING_ID);
    $link = Yii::$app->urlManager->createAbsoluteUrl(['/recharge-etecsa/update', 'id' => $recharge_id]);
...
<head>
    ...
    <title>Recarga ETECSA solicitada</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                                            ...
                                            <tr>
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:560px">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0;padding-bottom:15px"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#333333">¡Nueva solicitud de recarga ETECSA registrada en el sitio <?= Setting::getName() ?>!</h2></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0;padding-top:20px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Saludos hemos recibido una nueva solicitud de recarga de servicio de ETECSA en nuestra plataforma y se encuentra en espera de procesamiento. </p></td>
                                                        </tr>
                                                        <tr>
