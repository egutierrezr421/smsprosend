...
class RegexCustomValidator
{
    ...
    public $message_only_number;
    public $pattern_only_number;
    ...
    public function __construct()
    {
        ...
        $this->message_only_number = Yii::t('backend','Este campo solo acepta números');
        $this->pattern_only_number = '/^[0-9]*$/';
    }
     ...
     * @return string
     */
    public function getPatternOnlyNumber()
    {
        return $this->pattern_only_number;
    }

    /**
     * @param string $pattern_only_number
     */
    public function setPatternOnlyNumber($pattern_only_number)
    {
        $this->pattern_only_number = $pattern_only_number;
    }

    /**
     * @return string
     */
    public function getMessageOnlyNumber()
    {
        return $this->message_only_number;
    }

    /**
     * @param string $message_only_number
     */
    public function setMessageOnlyNumber($message_only_number)
    {
        $this->message_only_number = $message_only_number;
    }
