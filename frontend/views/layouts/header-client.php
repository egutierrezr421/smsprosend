...
<header class="header navbar navbar-expand-lg navbar-light bg-blue-kubacel navbar-sticky navbar-stuck">
    <div class="container">
        ...
        <a class="ms-2 me-2 text-decoration-none" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu">
        ...
        <div class="order-lg-3">
            <a class="me-4" href="<?= Url::to(['/site/profile']) ?>" title="perfil">
                <img class="avatar-image" src="<?= \common\models\User::getUrlAvatarByActiveUser(true) ?>" alt="avatar">
            </a>
